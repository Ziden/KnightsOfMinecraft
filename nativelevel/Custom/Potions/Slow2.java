...
public class Slow2 extends CustomPotion {
    ...
    private PotionEffect efeito = new PotionEffect(PotionEffectType.SLOW, 20 * 20, 2);

    public Slow2() {
        super(L.m("Poção de Desaleceração Forte"), L.m("Causa Desaceleração a Todos"), PotionType.SLOWNESS, true);
    }
