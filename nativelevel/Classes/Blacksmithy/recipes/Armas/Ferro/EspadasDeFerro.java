 ...
 *
 */
public class EspadasDeFerro extends CustomCrafting {

    public EspadasDeFerro() {
        super("Espadas de Ferro Aprimoradas", "Crie espadas de ferro aprimoradas");
    }
    ...
    public ItemStack aplicaNoCraftNormal(ItemStack ss) {
        if(ss.getType()!=Material.IRON_SWORD) 
            return ss;
        double dano = WeaponDamage.getDamage(ss);
        dano -= 1;
