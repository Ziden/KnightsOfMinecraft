 ...
 *
 */
public class MachadoDeFerro extends CustomCrafting {

    public MachadoDeFerro() {
        super("Machado de Ferro Aprimoradas", "Crie machados de ferro aprimoradas");
    }
    ...
    public ItemStack aplicaNoCraftNormal(ItemStack ss) {
        if(ss.getType()!=Material.IRON_AXE) 
            return ss;
        double dano = WeaponDamage.getDamage(ss);
        dano -= 1;
