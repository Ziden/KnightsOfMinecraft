...
public enum ParticleEffect {
    ...
    /**
     * Displays an icon crack (item break) effect which is visible for all players whitin a certain range in the the
     * world of @param loc
     */
    ...
    /**
     * Displays a block crack (block break) effect which is visible for all players whitin a certain range in the the
     * world of @param loc
     */
    ...
    /**
     * Displays a block dust effect which is visible for all players whitin a certain range in the the world of @param
     * loc
     */
